  ...
  render() {
    ...
    return (
      <div style={{ position: 'relative' }}>
        ...
        <input type='password' placeholder="输入密码" style={{ marginTop: "4vh", width: '80vw', marginLeft: '10%', height: '6vh', borderRadius: 10, border: 'none', textAlign: 'center', fontSize: '4vw' }} onChange={this.getFir} />
