        ...
        return (
            <div>
                ...
                <div style={{ marginTop: '3vh' }}>
                    <div style={{ backgroundColor: '#cccccc', height: '3.5vh', marginTop: '2vh', 
                    fontSize: 13, fontWeight: 800, borderRadius: 20 ,lineHeight:'3vh'}}>
                        <span style={{ marginLeft: '2vw', color: '#ba9346' }}>1、通识平台课程</span>
                    </div>
                    ...
                    <div style={{ backgroundColor: '#cccccc', height: '3.5vh', marginTop: '2vh', fontSize: 13, fontWeight: 800, borderRadius: 20 ,lineHeight:'3vh'}}>
                        <span style={{ marginLeft: '2vw', color: '#b85478' }}>2、大类平台课程</span>
                    </div>
                    ...
                    <div style={{ backgroundColor: '#cccccc', height: '3.5vh', marginTop: '2vh', fontSize: 13, fontWeight: 800, borderRadius: 20 ,lineHeight:'3vh'}}>
                        <span style={{ marginLeft: '2vw', color: '#eb6413' }}>3、学科平台课程</span>
                    </div>
                    ...
                    <div style={{ backgroundColor: '#cccccc', height: '3.5vh', marginTop: '2vh', fontSize: 13, fontWeight: 800, borderRadius: 20 ,lineHeight:'3vh'}}>
                        <span style={{ marginLeft: '2vw', color: '#222a41' }}>4、专业课程模块</span>
                    </div>
                    <div style={{ height: '60vh', width: '94vw', marginLeft: '3vw' ,lineHeight:'2.5vh'}}>
                        <li style={{ fontSize: 12, listStyle: 'none', marginTop: '1vh',lineHeight:'3vh'}}>
                    ...
                    <div style={{ backgroundColor: '#cccccc', height: '3.5vh', marginTop: '2vh', fontSize: 13, fontWeight: 800, borderRadius: 20 ,lineHeight:'3vh'}}>
                        <span style={{ marginLeft: '2vw', color: '#feefd8' }}>5、教师教育课程模块</span>
                    </div>
                    ...
                    <div style={{ backgroundColor: '#cccccc', height: '3.5vh', marginTop: '2vh', fontSize: 13, fontWeight: 800, borderRadius: 20 ,lineHeight:'3vh'}}>
                        <span style={{ marginLeft: '2vw', color: '#f2ef16' }}>6、实践教学课程</span>
                    </div>
                    ...
                    <div style={{ backgroundColor: '#cccccc', height: '3.5vh', marginTop: '2vh', fontSize: 13, fontWeight: 800, borderRadius: 20 ,lineHeight:'3vh'}}>
                        <span style={{ marginLeft: '2vw', color: '#638665' }}>7、综合素质课程模块</span>
                    </div>
                    <div style={{ height: '19vh', width: '94vw', marginLeft: '3vw' ,lineHeight:'2.5vh'}}>
                        <li style={{ fontSize: 12, listStyle: 'none', marginTop: '1vh',lineHeight:'3vh'}}>
