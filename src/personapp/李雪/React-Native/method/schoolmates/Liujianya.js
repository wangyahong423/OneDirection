        ...
        return (
            ...
            >
                <View style={styles.box}>
                    <Image source={require('../../../assets/gonglve/刘建亚.jpg')} style={styles.img} />
                    <Text style={styles.name}>【刘/建/亚】</Text>
                    <Image source={require('../../../assets/gonglve/line.png')} style={{ width: '90%' }} resizeMode='stretch' />
                    <Text style={styles.introduction}>
                        刘建亚，1964年生，长江学者、国家杰出青年基金获得者，教授、博士生导师。
                    </Text>
                    <Text style={styles.introduction}>
                        现任山东大学党委常委、副校长，威海校区校长，山东大学研究生院院长。
                    </Text>
