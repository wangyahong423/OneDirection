                ...
                <ScrollView>
                   <View style={{width:'100%',height:'100%'}}>
                       <Text>
                        ...
                        <Text style={{fontSize:15,marginTop:-15*s}}>
                        ...
                        <Text style={{fontSize:17,marginTop:5*s}}>
                        ...
                        <TouchableOpacity style={{marginLeft:170*s}}>
                            <Button style={{width:90*s,height:40*s,backgroundColor:'grey',}}>
                                <Text style={{color:'white',fontSize:10}}>点击查看答案</Text>
                            </Button>
                        </TouchableOpacity>
                   </View>
                </ScrollView>
