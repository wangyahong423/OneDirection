...
export default class MynotesDetails extends Component {
    constructor() {
        super();
        this.state = {
            data: [],
        ...
        return (
            <div style={{ position: 'relative' }}>
                <NavBar
                    ...
                    leftContent={[
                        <Link to="/mynotes"><span style={{ fontSize: '17px', color: 'white' }} className="iconfont icon-ico_leftarrow"></span></Link>
                    ]}
                >
                    <span>笔记详情</span>
                </NavBar>
                <div>
                    {
                        this.state.data.map((item, idx) =>
                            <div style={{ background: '#fff', color: 'black' }}>
                                ...
                                <p style={{ marginLeft:25, color: 'black', marginTop: 20, fontSize: 19 ,fontWeight:'bold'}}>{item.title}</p>
                                <hr style={{marginLeft:25,marginRight:25,marginTop:-10}}></hr>
