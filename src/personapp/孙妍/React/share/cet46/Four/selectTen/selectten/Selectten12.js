...
export default class Selectten12 extends Component {
    onChange = (key) => {
        console.log(key);
    }
    render() {
        return (
            <div>
                <NavBar
                    ...
                    leftContent={[
                        <Link to="/fourselectten"><span style={{ fontSize: '17px', color: 'white' }} className="iconfont icon-ico_leftarrow"></span></Link>
                    ]}
                >
                    <span>第十二篇</span>
                </NavBar>
