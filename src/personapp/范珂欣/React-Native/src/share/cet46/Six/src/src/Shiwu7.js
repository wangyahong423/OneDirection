...
export default class Shiwu7 extends Component {
    constructor() {
        super();
        this.state = {
            activeSections: [],
            ...
            <ScrollView>
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ width: '85%', margin: '7.5%' }}>
                        ...
                        <Text style={{ fontSize: 19, marginTop: 5 * s, fontStyle: 'italic', color: 'green' }}>A) deficit B) complaine C) severely D) allowanceE) considerately F) shuttle G) evacuate H) absentlyI) adequate　 J) dock K) resume L) vitalM) trivial N) evaluate O) fresh
                        </Text>
                    </View>
                </View>
                <Accordion
