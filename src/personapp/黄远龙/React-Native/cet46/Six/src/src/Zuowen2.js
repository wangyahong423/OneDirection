                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ width: '85%', margin: '7.5%' }}>
                        <Text style={{ fontSize: 16 * s }}>
                            &emsp;&emsp;{`seeding employment in u.k.`}
                        </Text>
                    </View>
                </View>
                <Accordion
