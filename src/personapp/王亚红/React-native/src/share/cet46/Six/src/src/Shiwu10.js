...
export default class Shiwu10 extends Component {
    constructor() {
        super();
        this.state = {
            activeSections: [],
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <View style={{ width: '85%', margin: '7.5%' }}>
                    ...
                    <Text style={{ fontSize: 19, marginTop: 5 * s, fontStyle: 'italic', color: 'green' }}>
                        A. maintainB. scenicC. transcendD. sourceE. estimatedF. sakeG. complexH.simplyI. consolidationJ. situatedK. respectivelyL. totalM. majorN. restrainedO. scale
                        </Text>
                </View>
            </View>
            <Accordion
