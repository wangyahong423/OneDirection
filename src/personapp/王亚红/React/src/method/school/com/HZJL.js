...
export default class HZJL extends Component {
        ...
        return (
            <div>
                ...
                <div style={{ marginTop: '1vh' }}>
                    <i className="iconfont icon-jiantou" style={{ marginLeft: '15vw',color:'blue' }}></i>
                    <a href="http://io.hebtu.edu.cn/" style={{ color: 'orange', fontWeight: 'bold', marginLeft: '5vw', fontSize: 12 }}>
                        相&nbsp;关&nbsp;链&nbsp;接：
                    </a>
                    <a style={{ color: 'blue', fontSize: 12,marginLeft:'2vw'}}>
                        国&nbsp;际&nbsp;合&nbsp;作&nbsp;交&nbsp;流&nbsp;中&nbsp;心
                    </a>
