        ...
        return (
            <SafeAreaView style={{ flex: 1 }} >
                ...
                <View style={{ backgroundColor: '#fff', width: '100%', }}>
                    ...
                    >
                        <Text >{this.state.page.content}</Text>
                    </View>
                </View>
                <View style={{
                    width: '100%',
                    ...
                    >
                        <Text style={{ color: 'white', fontSize: 16 * s }}>发送</Text>
                    </TouchableOpacity>
                </View>
                <View>
                    <Text style={{ paddingLeft: 10 * s, fontSize: 18 * s, marginBottom: 5 * s }}>评论</Text>
                </View>
                                ...
                                <View style={{ backgroundColor: '#fff', width: '100%', borderBottomWidth: 1 * s, borderBottomColor: '#EEEEEE' }}>
                                    <View style={{
                                        ...
                                        <View style={{ marginLeft: 30 * s, marginRight: 60 * s }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <Text style={this.state.page.name == item.name ? { fontSize: 15 * s, color: 'red', marginTop: 5 * s } : { fontSize: 16* s, color: '#37376F', marginTop: 5 * s }}>{item.name}</Text>
                                            ...
                                            <Text style={{ fontSize: 15 * s, color: '#808080', marginTop: 8 * s, marginBottom: 5 * s }}>{item.time}</Text>
                                        </View>
                                    </View>
                                    {
                    ...
                    </View>
                    {
                        this.state.isLoading
                            ...
                            <View style={{
                                ...
                                <Text style={{ fontSize: 21 * s, marginTop: 50 * s }}>正在获取数据...</Text>
                            </View>
                            : null
                    }
                </ScrollView>
