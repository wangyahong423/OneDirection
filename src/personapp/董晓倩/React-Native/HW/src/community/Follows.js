        ...
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: '#EEEEEE' }}>
                   <View style={{
                    ...
                    <Text style={{ color: '#fff', lineHeight: 60 * s, fontSize: 22 * s }}>关注列表</Text>
                </View>
                <ScrollView style={{ flex: 1 }}>
                    {
                        this.state.follow.map((item, idx) => (
                            <TouchableOpacity
                                ...
                                style={{ flexDirection: 'row', height: 90 * s, width: "100%", backgroundColor: "#fff", marginTop: 10 * s, alignItems: "center" }}>
                                <Image style={{
                                    marginLeft: 20 * s,
                                    height: 60 * s,
                                    width: 60 * s,
                                ...
                                <Text style={{ fontSize: 16 * s, marginLeft: 20 * s ,fontSize:19*s}}>{item.name}</Text>
                                {
                                        ...
                                        : <View style={{ position: "absolute", right: 20 * s }}>
                                            {
                                                this.state.myFol[idx]
                                                    ? <TouchableOpacity
                                                        ...
                                                        <Text style={{ fontSize: 16 * s }}>取消关注</Text>
                                                    </TouchableOpacity>
                                                    : <TouchableOpacity
                                                        onPress={this.follow.bind(this, (idx))}
