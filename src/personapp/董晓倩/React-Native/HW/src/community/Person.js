        ...
        return (
            <View style={{ flex: 1 }}>
                <SafeAreaView style={{ flex: 1 }} >
                    ...
                    >
                        <ImageBackground style={{ flex: 1, width: '100%', height: height * 0.35, }} source={require('../../assets/community/img2.png')} >
                        ...
                        <View style={{ height: 70 * s, width: width, backgroundColor: "#fff", flexDirection: "row", justifyContent: "space-around", alignItems: "center" }}>
                            <FlatList
                                horizontal={true}
                                data={[
                                    { key: '我的社区' },
                        ...
                        <View style={{
                        ...
                        }}>
                            {
                                this.state.mylearn
                                    ? <View style={{ flex: 1 }}>
                                        <Text style={{ marginBottom: 5 * s, marginTop: -5 * s, fontSize: 15 * s, marginLeft: 10 * s }}>全部帖子 ({this.state.learn})</Text>
                            ...
                            }
                            {
                                this.state.myexp
                                    ? <View>
                                        <Text style={{ marginBottom: 5 * s, marginTop: -5 * s, fontSize: 15 * s, marginLeft: 10 * s }}>全部帖子 ({this.state.exp})</Text>
                                        <PerExp />
                                    </View>
                                    : null
                            }
                            {
                                this.state.mycollect
                                    ? <View>
                                        <Text style={{ marginBottom: 5 * s, marginTop: -5 * s, fontSize: 15 * s, marginLeft: 10 * s }}>全部帖子 ({this.state.collect})</Text>
                                        <PerExp />
                                    </View>
                                    : null
                            }
                            {
                                this.state.personlearn
                                    ? <View>
                                        <Text style={{ marginBottom: 5 * s, marginTop: -5 * s, fontSize: 15 * s, marginLeft: 10 * s }}>全部帖子 ({this.state.PLLike})</Text>
                                        <PerLearn />
                                    </View>
                                    : null
                            }
                            {
                                this.state.personexp
                                    ? <View>
                                        <Text style={{ marginBottom: 5 * s, marginTop: -5 * s, fontSize: 15 * s, marginLeft: 10 * s }}>全部帖子 ({this.state.PELike})</Text>
                                        <PerExp />
                                    </View>
                                    : null
                            }
                ...
                </SafeAreaView >
                {
                    this.state.isTop === true ? <ActionButton
                        renderIcon={() => (<View style={{ height: 70 * s, width: 70 * s, backgroundColor: "#F8F8F8", borderRadius: 35 * s, justifyContent: "center", alignItems: "center", borderWidth: 1, borderColor: "#F9F9F9" }}><Icon style={{ fontSize: 50 * s, color: "#8C8C8C" }} name="publish" /></View>)}
                        buttonColor="#FFFFFF"
                        position='right'
                ...
                {
                    this.state.tabShow ?
                        <View style={{ position: "absolute", flexDirection: "row", alignItems: "center", justifyContent: "space-between", height: 60 * s, width: width, top: 25 * s }}>
                            <TouchableOpacity style={{ zIndex: 4, height: 40 * s, width: 40 * s, justifyContent: "center" }} onPress={() => this.back()}>
                                <Icon name="chevron-left" style={{ fontSize: 50 * s, color: "black" }} />
                            </TouchableOpacity>
                            <TouchableOpacity style={{ zIndex: 4, height: 40 * s, width: 55 * s, }} onPress={() => this.search()}>
                                <Icon style={{ fontSize: 35 * s, color: "black" }} name="magnify" />
                            </TouchableOpacity>
                        </View>
                        :
                        <View style={{ position: "absolute", flexDirection: "row", alignItems: "center", justifyContent: "space-between", height: 60 * s, width: width, top: 25 * s }}>
                            <TouchableOpacity style={{ zIndex: 4, height: 40 * s, width: 40 * s, justifyContent: "center" }} onPress={() => this.back()}>
                                <Icon name="chevron-left" style={{ fontSize: 50 * s, color: "#F8F8F8" }} />
                            </TouchableOpacity>
                            <TouchableOpacity style={{ zIndex: 4, height: 40 * s, width: 55 * s, }} onPress={() => this.search()}>
                                <Icon style={{ fontSize: 35 * s, color: "#F8F8F8", }} name="magnify" />
                            </TouchableOpacity>
                        </View>
                }
