            ...
            <SafeAreaView style={{ flex: 1 }}>
                <ImageBackground style={{ flex: 1, width: width, height: height }} source={require('../../assets/login/login8.png')}>
                    ...
                    <View style={{ alignItems: "center", justifyContent: "center", marginTop: height * 0.05 }}>
                        <View style={{ flexDirection: 'row', marginTop: 15, height: 50 * s, width: '80%', borderBottomWidth: 1, borderBottomColor: "#fff", alignItems: "center" }}>
                            <Icon name="user-o" color="#fff" size={25 * s} style={{ marginLeft: 15 * s }} />
                            <TextInput onChangeText={this.nameChange} placeholder="请输入用户名" placeholderTextColor="#fff" style={{ color: "#fff", marginLeft: 10 }} />
                        </View>
                        <View style={{ flexDirection: 'row', marginTop: 15, height: 50 * s, width: '80%', borderBottomWidth: 1, borderBottomColor: "#fff", alignItems: "center" }}>
                            <Icon name="mobile-phone" color="#fff" size={34 * s} style={{ marginLeft: 15 * s }} />
                            <TextInput onChangeText={this.telChange} placeholder="请输入手机号码" placeholderTextColor="#fff" style={{ color: "#fff", marginLeft: 15 }} />
                        </View>
                        <View style={{ flexDirection: 'row', marginTop: 15, height: 50 * s, width: '80%', borderBottomWidth: 1, borderBottomColor: "#fff", alignItems: "center" }}>
                            <Icon name="lock" color="#fff" size={30 * s} style={{ marginLeft: 15 * s }} />
                            <TextInput onChangeText={this.getNewPwd} secureTextEntry={true} placeholder="请输入新密码" placeholderTextColor="#fff" style={{ color: "#fff", marginLeft: 10 }} />
                        </View>
                        <View style={{ flexDirection: 'row', marginTop: 15, height: 50 * s, width: '80%', borderBottomWidth: 1, borderBottomColor: "#fff", alignItems: "center" }}>
                            <Icon name="lock" color="#fff" size={30 * s} style={{ marginLeft: 15 * s }} />
                            <TextInput onChangeText={this.getReNewPwd} secureTextEntry={true} placeholder="请再次确认新密码" placeholderTextColor="#fff" style={{ color: "#fff", marginLeft: 10 }} />
                        </View>
                    </View>
