            ...
            <View
              ...
              </TouchableOpacity>
              {
                this.state.unum == 0
                  ...
                  : <View style={{ height: 40, justifyContent: 'center', position: 'absolute', top: 140*s, left: 65 }}><Text style={{ color: 'red', fontSize: 13 }}>请输入用户名！</Text></View>
              }
              {
                this.state.pnum == 0
                  ? <View style={{ position: 'absolute', top: 290 }}><Text></Text></View>
                  : <View style={{ height: 40, justifyContent: 'center', position: 'absolute', top: 220*s, left: 65 }}><Text style={{ color: 'red', fontSize: 13 }}>请输入正确的密码！</Text></View>
              }
            </View>
          </View>
          {
