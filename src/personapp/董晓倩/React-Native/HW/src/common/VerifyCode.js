    ...
    render() {
        ...
        return (
            <View style={{ alignItems: 'center', marginTop: '12%' }}>
                <View style={{ flexDirection: 'row', marginTop: 25, height: 50 * s, width: '80%', borderBottomWidth: 1, borderBottomColor: "#fff", alignItems: "center" }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    <View style={{ flexDirection: 'row', marginTop: 25, height: 50 * s, width: '53%', borderBottomWidth: 1, borderBottomColor: "#fff", alignItems: "center" }}>
                ...
                <View style={{ flexDirection: "row"}}>
                    <View style={[props.containerStyle, { marginTop: 25, height: 50 * s, width: '40%', borderBottomWidth: 1, borderBottomColor: "#fff",marginRight:20*s ,marginLeft:25*s}]}>
                        <Icon name="edit" color="#fff" size={25 * s} />
