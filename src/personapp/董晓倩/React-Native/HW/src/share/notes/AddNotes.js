            ...
            <SafeAreaView style={{ flex: 1 }}>
                <ImageBackground style={{ width: '100%', height: height }} source={require('../../../assets/share/notes.png')}>
                    <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                        <TouchableOpacity style={{ height: 60 * s, width: 50 * s, justifyContent: "center", alignItems: "center" }} onPress={() => Actions.pop()}>
                            <Icon name="ios-arrow-back" style={{ fontSize: 35 * s, color: "#54487D" }} />
                        </TouchableOpacity>
                        <TouchableOpacity style={{ height: 60 * s, width: 60 * s, justifyContent: "center", alignItems: "center" }} onPress={this.add}>
                            <Icon name="ios-checkmark" style={{ fontSize: 60 * s, color: "#54487D" }} />
                        </TouchableOpacity>
                    </View>
                    <TextInput
                        placeholder="标题"
                        ...
                        style={{ marginLeft: 10 * s, fontSize: 21 * s }}
                    />
                    <TextInput
                        placeholder="输入笔记内容"
                        placeholderTextColor='#666666'
                        ...
                        multiline={true}
                        autoFocus={true}
                        style={{ marginLeft: 10 * s,fontSize: 19 * s ,marginTop:-10*s}}
