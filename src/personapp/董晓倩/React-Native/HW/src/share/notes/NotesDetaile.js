                ...
                <ImageBackground style={{ flex: 1, width: '100%', height: height }} source={require('../../../assets/share/notes.png')}>
                    <ScrollView style={{ width: '100%', height: "100%" }}>
                        <View style={{ flexDirection: "row" }}>
                            <Text style={{ marginLeft: 15 * s, marginTop: 10 * s ,}} onPress={() => Actions.pop()}>
                                <Icon name="ios-arrow-back" style={{ fontSize: 35 * s, color: "#54487D" }} />
                            </Text>
                            <Text style={{ marginLeft: 340 * s, marginTop: 10 * s,}} onPress={this.delete.bind(this, (this.state.page.id))}>
                                <Icon name="ios-trash" style={{ fontSize: 40 * s }} />
                            </Text>
