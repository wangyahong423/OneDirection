                ...
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        <TouchableOpacity style={{ backgroundColor: '#eee', margin: 5 * s, height: 40 * s, justifyContent: "center" }} onPress={this.classify.bind(this, (item.key))}>
                            <Text style={{
                                backgroundColor: 'blur', marginLeft: 15 * s
                            }}>{item.key}</Text>
                        </TouchableOpacity>
                    }
                />
        ...
        return (
            <SafeAreaView style={{ flex: 1 }} >
                <View style={{
                    ...
                    <Text style={{ color: '#fff', lineHeight: 60 * s, fontSize: 22 * s }}>经验分享</Text>
                </View>
                <DrawerLayoutAndroid
                    ref={(drawer) => {
                        this.drawer = drawer;
                    ...
                    <View style={{
                        ...
                        >
                            <Text style={{ color: "#37376F", fontSize: 20 * s, marginLeft: 10 * s }}>分类</Text>
                        </TouchableOpacity>
                        <View style={{
                            height: 40 * s,
                            width: width * 0.7,
