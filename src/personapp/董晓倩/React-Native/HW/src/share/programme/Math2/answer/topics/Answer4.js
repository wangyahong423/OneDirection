    ...
    constructor() {
        ...
        this.state = {
            ...
            todo: [{
                header: '参考答案',
                content1: '【答案】C/x',
                content2: '令y=xu,则dy=xdu+udx,代入原方程得',
                content3: '3(1+u-u^2)dx+x(1-2u)du=0',
                content4: '分离变量得(1-2u)/(1+u-u^2)du=-3/xdx',
                content5: "积分得ld(1+u-u^2)/(1+u-u^2)=-3l1/xdx",
                content6: "即 1+u-u^2=Cx^-3",
                content7:"以u=y/x代入得通解x^2+xy-y^2=C/x",
            }]
        }
    }
