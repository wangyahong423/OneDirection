...
import { Text, View, StyleSheet, TouchableOpacity, Image, FlatList, ScrollView, Dimensions, SafeAreaView } from 'react-native';
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{
                    ...
                    <Text style={{ color: '#fff', lineHeight: 60 * s, fontSize: 22 * s }}>杰出校友</Text>
                </View>
                <ScrollView>
                    <View style={styles.box}>
                        <TouchableOpacity style={styles.block} onPress={this.cailimin}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/才利民.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.caijiming}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/蔡继明.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.chaiguanjing}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/柴冠景.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.chenshuzeng}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/陈书增.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.dengyingchao}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/邓颖超.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.fanqianwen}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/范千文.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.fengjiannan}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/冯建男.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.fengshaohui}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/冯韶慧.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.gesangdeji}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/格桑德吉.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.hehong}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/贺弘.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.houliang}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/侯亮.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.lishushen}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/李树深.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.liyimin}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/李益民.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.lizhanshu}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/栗战书.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.liangxingjie}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/梁兴杰.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.linwanli}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/林万里.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.liujianya}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/刘建亚.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.liuyongrui}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/刘永瑞.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.longzhuangwei}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/龙庄伟.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.luhongchang}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/路洪昌.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.mayujun}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/马宇骏.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.panglaixing}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/庞来兴.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.situlanfang}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/司徒兰芳.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.suguoan}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/苏国安.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.wangfengming}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/王凤鸣.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.wangjinjiang}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/王进江.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.wangzhixin}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/王志欣.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.xiachuancai}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/夏传才.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.yanluguang}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/严陆光.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.yuanzhigang}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/袁志刚.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.zhanghe}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/张和.png')} style={styles.imgs} />
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.zhangmeizhi}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/张妹芝.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.block} onPress={this.zhangyanping}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                ...
                                <Image source={require('../../../assets/gonglve/张砚平.png')} style={styles.imgs} />
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.block} onPress={this.zhangzhiwei}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                                <Image source={require('../../../assets/gonglve/张志伟.png')} style={styles.imgs} />
