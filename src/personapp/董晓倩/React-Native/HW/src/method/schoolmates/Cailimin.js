        ...
        return (
            ...
            >
                <View style={styles.box}>
                    <Image source={require('../../../assets/gonglve/才利民.png')} style={styles.img} />
                    <Text style={styles.name}>【才/利/民】</Text>
                    <Image source={require('../../../assets/gonglve/line.png')} style={{ width: '90%' }} resizeMode='stretch' />
                    <Text style={styles.introduction}>
                        才利民，男，满族，1955年1月生，出生于河北省宽城满族自治县双庙沟，1972年4月参加工作，1975年8月加入中国共产党，在职研究生文化，清华大学管理学博士。
                    </Text>
                    <Text style={styles.introduction}>
                        曾任山东省人大常委会副主任、党组副书记。
                    </Text>
