        ...
        return (
            <SafeAreaView>
                <View style={styles.header}>
                    <Text style={{ color: '#fff', lineHeight: 60 * s, fontSize: 22 * s }}>校园新生通</Text>
                </View>
                {/* 轮播图 */}
                <ScrollView >
                    ...
                    <View style={{ width: width, height: 600 * s }}>
                        ...
                        <View style={styles.six}>
                            <View style={styles.sixOne}>
                                <TouchableOpacity onPress={this.onecard} style={styles.one}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#37376F' }}><Icon name='vcard-o' size={28} color="white" /></View>
                                    <Text style={{ marginTop: 10 }}>一卡通</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.organization} style={styles.one}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#37376F' }}><Icon name='resistance' size={28} color="white" /></View>
                                    <Text style={{ marginTop: 10 }}>社团组织</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.school} style={styles.one}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#37376F' }}><Icon name='fort-awesome' size={28} color="white" /></View>
                                    <Text style={{ marginTop: 10 }}>学校</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={styles.sixOne}>
                                <TouchableOpacity onPress={this.study} style={styles.one}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#37376F' }}><Icon name='trophy' size={28} color="white" /></View>
                                    <Text style={{ marginTop: 10 }}>学习</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.schoolmates} style={styles.one}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#37376F' }}><Icon name='group' size={25} color="white" /></View>
                                    <Text style={{ marginTop: 10 }}>杰出校友</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.college} style={styles.one}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#37376F' }}><Icon name='mortar-board' size={28} color="white" /></View>
                        ...
                        <TouchableOpacity onPress={() => { Actions.collegemajor() }} style={{ width: '94%', backgroundColor: 'red', marginTop: 15 * s, marginLeft: '3%', borderRadius: 30, overflow: 'hidden' }}>
                            <ImageBackground style={{ width: '100%', flexDirection: 'row' }} source={require('../../assets/gonglve/ks.png')}>
                                <Icon name='search' size={20} style={{ lineHeight: 60 * s, marginLeft: 20 }} color="white" />
                                <Text style={{ lineHeight: 60 * s, fontSize: 23 * s, color: '#ceff85', fontWeight: 'bold', marginLeft: 10 * s, textShadowColor: '#C0C0C0', textShadowRadius: 5, textShadowOffset: { width: 5 * s, height: -4 * s } }}>快速了解自己的专业？</Text>
                        ...
                        <View style={styles.ying}>
                            ...
                            <View style={styles.sixOne}>
                                <TouchableOpacity onPress={() => { Actions.notesks() }} style={styles.yjzd}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#37a9c7' }}><Icon name='search' size={28} color="white" /></View>
                                    <Text style={{ marginTop: 10 * s, color: '#37a9c7' }}>添加笔记</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => { Actions.obtainemployment() }} style={styles.one}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#efcd00' }}><Icon name='hand-stop-o' size={28} color="white" /></View>
                                ...
                                <TouchableOpacity onPress={() => { Linking.openURL('http://xyh.hebtu.edu.cn/').catch(err => console.error('An error occurred', err)); }} style={styles.yjzd}>
                                    <View style={{ height: 70 * s, width: 70 * s, alignItems: 'center', justifyContent: 'center', borderRadius: 35 * s, backgroundColor: '#12ed5a' }}><Icon name='handshake-o' size={28} color="white" /></View>
