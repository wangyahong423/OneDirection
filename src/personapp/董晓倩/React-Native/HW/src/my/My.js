    ...
    render() {
        return (
            <ScrollView style={{ backgroundColor: "#fff" }}>
                <ImageBackground style={{ height: 310*s, width: '100%', alignItems: "center" }} source={require('../../assets/community/img12.png')} >
                    <View style={{ height: 50 * s, width: 50 * s, flexDirection: "row", justifyContent: "space-between", paddingTop: 10, paddingLeft: 10, paddingRight: 10, marginLeft: width * 0.8 }}>
                        <TouchableOpacity onPress={() => Actions.shezhi()} style={{ height: 50 * s, width: 50 * s, justifyContent: "center", alignItems: "center", }}>
                            <Icon style={{ color: "#fff", fontSize: 30 * s, }} name="settings-outline" />
                        </TouchableOpacity>
                    </View>
                    <TouchableOpacity style={{ width: 90, height: 90 ,justifyContent:"center",alignItems:"center"}} onPress={() => Actions.touxiang()}>
                    ...
                    <Text style={{  color: "#fff" ,marginTop:8*s}}>
                        {this.state.username}&nbsp;&nbsp;&nbsp;
                            <Image style={{ height: 25 * s, width: 40 * s, marginLeft: 10 * s }} source={Img['png' + this.state.level]} />
                    </Text>
                    <Text style={{  color: "#fff", marginTop: 5 * s }}>河北师范大学{this.state.college}</Text>
                            ...
                            this.state.num
                                ...
                                <View style={{ height: 50 * s, width: 50 * s, justifyContent: "center", alignItems: "center" }}>
                                    <TouchableOpacity onPress={() => this.followslist()} >
                                        <Text style={{ color: "#fff",fontSize:16*s }}>关注</Text>
                                    </TouchableOpacity>
                            ...
                            this.state.num3
                                ...
                                <View style={{ height: 50 * s, width: 50 * s, justifyContent: "center", alignItems: "center" }}>
                                    <TouchableOpacity onPress={() => this.fanslist()} >
                                        <Text style={{ color: "#fff" ,fontSize:16*s }}>粉丝</Text>
                                    </TouchableOpacity>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        <TouchableOpacity onPress={() => this.fanslist()} >
                ...
                <View >
                    <View style={{
                        ...
                        borderTopColor: '#ffffff', borderRightColor: '#ffffff', borderWidth: 1,marginTop:10
                    }}  >
                        <TouchableOpacity onPress={() => Actions.biji()} style={{ flexDirection: 'row', alignItems: "center" }}>
                            <View style={{ height: 50, width: 80, justifyContent: "center", alignItems: "center" }}>
                                <Icon name="feather" size={28} color="#fed658" />
                            </View>
                            <View style={{ height: 50, width: width * 0.7, }}>
                                <Text style={{ fontSize: 22*s, marginTop: 11 }}>我的笔记</Text>
                            </View>
                        ...
                        this.state.cnum + this.state.likenum
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity onPress={() => Actions.tiezi()} style={{ flexDirection: 'row', alignItems: "center" }}>
                                    <View style={{ height: 50, width: 80, justifyContent: "center", alignItems: "center" }}>
                                        <Icon name="file-document-edit-outline" size={28} color="#5f6fcd" />
                                    </View>
                                    <View style={{ height: 50, width: width * 0.633, flexDirection: 'row' }}>
                                        <Text style={{ fontSize: 22*s, marginTop: 11 }}>我的帖子</Text>
                            ...
                            : <View style={{
                                ...
                                <TouchableOpacity onPress={() => Actions.tiezi()} style={{ flexDirection: 'row', alignItems: "center" }}>
                                    <View style={{ height: 50, width: 80, justifyContent: "center", alignItems: "center" }}>
                                        <Icon name="file-document-edit-outline" size={28} color="#FF999A" />
                                    </View>
                                    <View style={{ height: 50, width: width * 0.7, }}>
                                        <Text style={{ fontSize: 22*s, marginTop: 11 }}>我的帖子</Text>
                                    </View>
                        ...
                        this.state.ecnum + this.state.elikenum
                            ...
                            : <View style={{
                                ...
                                <TouchableOpacity onPress={() => Actions.myexperence()} style={{ flexDirection: 'row', alignItems: "center" }}>
                                    ...
                                    <View style={{ height: 50, width: width * 0.7, }}>
                                        <Text style={{ fontSize: 22*s, marginTop: 11 }}>我的经验</Text>
                                    </View>
                                    <Icon name="chevron-right" size={20} color="#aaa" />
                                </TouchableOpacity>
                            </View>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => Actions.tongxun()} style={{ flexDirection: 'row', alignItems: "center" }}>
                            ...
                            <View style={{ height: 50, width: width * 0.7 }}>
                                <Text style={{ fontSize: 22*s, marginTop: 11 }} >通讯录</Text>
                            </View>
                            <Icon name="chevron-right" size={20} color="#aaa" />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => Actions.head()} style={{ flexDirection: 'row', alignItems: "center" }}>
                            ...
                            <View style={{ height: 50, width: width * 0.7 }}>
                                <Text style={{ fontSize: 22*s, marginTop: 11 }} >头像框</Text>
                            </View>
                            <Icon name="chevron-right" size={20} color="#aaa" />
                        </TouchableOpacity>
                    </View>
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => Actions.card()} style={{ flexDirection: 'row', alignItems: "center" }}>
                            <View style={{ height: 50, width: 80, justifyContent: "center", alignItems: "center" }}>
                                <Icon name="image" size={28} color="#9ACC99" />
                            </View>
                            <View style={{ height: 50, width: width * 0.7 }}>
                                <Text style={{ fontSize: 22*s, marginTop: 11 }} onPress={() => Actions.card()}>卡片</Text>
                            </View>
                            <Icon name="chevron-right" size={20} color="#aaa" />
                        </TouchableOpacity>
                    </View>
