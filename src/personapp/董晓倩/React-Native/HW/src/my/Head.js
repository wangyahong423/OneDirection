...
export default class Head extends Component {
    ...
    render() {
        return (
            <SafeAreaView style={{ backgroundColor: '#E9E9EF', flex: 1 }}>
                <ImageBackground style={{ height: 220 * s, width: '100%', }} source={require('../../assets/community/img14.png')} >
                    <View style={{ width: "100%", height: 50 * s, flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                        <TouchableOpacity style={{ height: 40 * s, width: 40 * s, position: "absolute", top: 5, left: 5, }} onPress={() => this.back()}>
                            <Icon name="chevron-left" style={{ fontSize: 50 * s, color: "#37376F" }} />
                        </TouchableOpacity>
                        <Text style={{ color: "#37376F", fontSize: 23 * s,marginTop:10 }}>头 像 框</Text>
                    </View>
                    <View style={{ justifyContent: "center", alignItems: "center", height: 200 * s, width: "100%", marginTop: -20 * s }}>
                ...
                <View style={{ flexDirection: "row", width: width, height: 500*s, flexWrap: 'wrap', backgroundColor: "#E9E9EF" }}>
                    {
                        this.state.list.map((item, idx) => (
                            <TouchableOpacity onPress={this.selected.bind(this, (idx))} style={{ justifyContent: "center", alignItems: 'center', backgroundColor: "#fff", width: width * 0.32, height: width * 0.32, marginLeft: width * 0.01, marginTop: width * 0.01 }} >
                                ...
                                <Image
                                    style={{ width: 80 * s, height: 80 * s, borderRadius: 40 * s, fontSize: 50 * s, position: "absolute", top: 10*s, left: 34*s }}
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{
                        ...
                        onPress={() => this.sure()}
                    >
                        <Text style={{ color: '#fff', fontSize: 21 * s }}>立即设置</Text>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
        )
