...
import { Text, View, ScrollView, Dimensions, ImageBackground, Animated, TouchableOpacity, StyleSheet, } from 'react-native'
        ...
        return (
            <ImageBackground style={{ width: '100%', height: height }} source={require('../../../assets/gonglve/beijing.jpg')}>
                <View style={{ width: width, height: 60 * s, flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <Text style={{ fontSize: 20 * s }}>综合学生测评</Text>
                </View>
                <ScrollView >
                    ...
                    <Animated.View style={{ height: this.state.height7, width: '100%', marginBottom: 40 }}>
                        <ImageBackground style={{ height: '98%', width: '95%', marginLeft: '2.5%', }}  >
