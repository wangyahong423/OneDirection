        ...
        return (
            ...
            >
                <View style={styles.box}>
                    <Image source={require('../../../assets/gonglve/李益民.png')} style={styles.img} />
                    <Text style={styles.name}>【李/益/民】</Text>
                    <Image source={require('../../../assets/gonglve/line.png')} style={{ width: '90%' }} resizeMode='stretch' />
                    <Text style={styles.introduction}>
                        李益民，女，汉族，1953年5月生，河北永年人。1970年参加工作，1974年4月加入中国共产党，1978年毕业于河北师范学院，大学学历，一级律师。
                    </Text>
                    <Text style={styles.introduction}>
                        现为河北省司法厅厅长。
                    </Text>
