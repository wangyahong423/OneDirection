        ...
        return (
            ...
            >
                <View style={styles.box}>
                    <Image source={require('../../../assets/gonglve/陈书增.png')} style={styles.img} />
                    <Text style={styles.name}>【陈/书/增】</Text>
                    <Image source={require('../../../assets/gonglve/line.png')} style={{ width: '90%' }} resizeMode='stretch' />
                    <Text style={styles.introduction}>
                        陈书增，男，汉族，1965年10月生，河北内丘人，1986年6月加入中国共产党，1986年7月参加工作，河北师范学院中文系中文专业毕业，大学学历，中国社会科学院法学硕士学位。
                    </Text>
                    <Text style={styles.introduction}>
                        现任河北省政协秘书长、党组成员、机关党组书记。
                    </Text>
