        ...
        return (
            ...
            >
                <View style={styles.box}>
                    <Image source={require('../../../assets/gonglve/张志伟.jpg')} style={styles.img} />
                    <Text style={styles.name}>【张/志/伟】</Text>
                    <Image source={require('../../../assets/gonglve/line.png')} style={{ width: '90%' }} resizeMode='stretch' />
                    <Text style={styles.introduction}>
                        张志伟，汉族，1963年5月出生于河北省，毕业于河北师范大学，是中国内地男演员。
                    </Text>
                    <Text style={styles.introduction}>
                        其影视代表作品有《盖世英雄方世玉》、《竞雄女侠秋瑾》、《利箭纵横》、《错伏》等。
                    </Text>
