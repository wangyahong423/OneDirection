    ...
    <>
      ...
      >
        <Scene key='root'>
          ...
          <Scene title='个人信息' key="person" component={Person} backButtonImage={require('./assets/gonglve/left.png')} navigationBarStyle={{ backgroundColor: '#37376F' }} titleStyle={{ flex: 1, textAlign: 'center', color: 'white', marginLeft: -40 }}  />
