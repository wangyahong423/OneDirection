...
export default class Fill17 extends Component {
    constructor() {
        super();
        this.state = {
            activeSections: [],
            todo: [{
                ...
                content1: '【答案】-1/2',
                content2: '【解析】',
                content3: 'lim(x->) ln(cos x)/x^2',
                content4:"=lim(x->0) (cos x-1)/x^2",
                content5:"=lim(x->0) (-1/2*x^2)/x^2",
                content6:"=-1/2"
            }]
        }
    }
            ...
            <ScrollView>
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ width: '85%', margin: '7.5%', borderColor: '#37376F', borderWidth: 1, padding: '2%' }}>
                        <Text style={{ fontSize: 16 * s }}>{`17、lim(x->0) ln cosx/x^2 =______`}</Text>
                    </View>
                </View>
                <Accordion
