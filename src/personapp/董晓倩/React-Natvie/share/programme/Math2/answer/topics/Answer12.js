    ...
    constructor() {
        ...
        this.state = {
            ...
            todo: [{
                header: '参考答案',
                content1: '【答案】',
                content2: '把方程化为标准形式得到(1+y^2)dy/dx=1-x^2,这是一个可分离变量的一阶微分方程，两边分别积分可得方程通解为：1/3y^3+y=x-1/3x^3+C,由y(2)=0,得c=2/3',
                content3: "即1/3y^3+y=x-1/3x^3+2/3",
                content4: "令dy/dx=(1-x^2)/(1+y^2)=0,得x=±1,",
                content5: "∴当x=1时，y=1，极大值为y=1;当x=-1时，极小值为y=0"
            }]
        }
    }
