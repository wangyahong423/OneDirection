...
export default class CNJ4 extends Component {
    constructor() {
        ...
        this.state = {
            todo: ['答案'],
            activeSections: [],
            answerContent: ["国家体育总局(the General Administration of Sport)在一项调查中 发现，自2010年以来，20-39岁的中国人体重增加更多——1.9千克。 这个年龄段中超过11%的人属于肥胖，这在三年的时间里就上涨了 两个百分点。"]
        }
    }
            ...
            <ScrollView>
                <View style={{ justifyContent: 'center', flex: 1, alignItems: 'center', marginBottom: 20 }}>
                    <View style={{ width: '95%', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Text style={{ lineHeight: 22, fontSize: 16 }}>&nbsp;&nbsp;&nbsp;&nbsp;China’s young adults are gaining more weight and exercising less than their elders. Chinese from ages 20 to 39 have put on more kilograms — 1.9 kg ——than other adults since 2010，the General Administration of Sport found in a survey. More than 11% from the age group were obese, up two percentage points in only three years.</Text>
                        <Accordion
