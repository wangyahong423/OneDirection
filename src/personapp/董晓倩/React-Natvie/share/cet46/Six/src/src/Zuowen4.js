    ...
    constructor() {
        ...
        this.state = {
            ...
            todo: [{
                ...
                content5: 'Today, with the establishment of more and more groups and big corporations, how smallbusinesses can survive in the tide of the market competitive economy has become a hotsocial issue.',
            }]
        }
    }
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ width: '85%', margin: '7.5%' }}>
                        <Text style={{ fontSize: 16 * s }}>
                            &emsp;&emsp;{`The Decline of Small Businesses`}
                        </Text>
                    </View>
                </View>
                <Accordion
