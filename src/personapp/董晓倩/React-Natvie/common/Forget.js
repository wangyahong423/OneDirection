...
import { View,  AsyncStorage, ScrollView, TextInput,Text } from 'react-native';
        ...
        return (
            <ScrollView style={{ backgroundColor: 'white' }}>
                ...
                <View style={{ marginTop: '10%', marginLeft: '20%' }}>
                    <Button style={{ borderRadius: 20, width: '75%' ,backgroundColor:'#37376F'}} onPress={this.getRepwd}><Text style={{color:'white'}}>重置密码</Text></Button>
                </View>
