...
export default class Details extends Component {
    ...
    add = () => {
        if (this.state.content) {
            ...
            let url = `http://139.155.44.190:3005/communitytalk/add?content=${this.state.content}&name=${this.state.username}&time=${time}`;
            fetch(url)
                .then((res) => res.json())
                .then((res) => {
                    if (res.ok) {
                    ...
                    this.state.data.map((item, idx) => (
                        <View style={{ backgroundColor: '#fff', width: '100%' }}>
                            ...
                            {/* <View style={styles.bottom}>
                                ...
                                <Icon name="heart" style={{ fontSize: 30 * s }}></Icon>
                            </View> */}
