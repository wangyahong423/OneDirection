                ...
                <View style={styles.six}>
                    ...
                    <View style={styles.sixOne}>
                        ...
                        <TouchableOpacity onPress={this.schoolmates} style={styles.one}>
                            <View style={{height:70*s,width:70*s,alignItems:'center',justifyContent:'center',borderRadius:35*s,backgroundColor:'blue'}}><Icon  name='group' size={36} color="white" /></View>
