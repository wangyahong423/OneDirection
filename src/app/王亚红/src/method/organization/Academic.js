            ...
            <ScrollView>
                <View style={styles.box}>
                    <View style={styles.dexin}>
                        <ImageBackground source={require('../../../assets/gonglve/dexinshe.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:65*s,marginTop:10*s}}>德馨社</Text>
                    </View>
                    <View style={styles.xiaofeiyang}>
                        <ImageBackground source={require('../../../assets/gonglve/feiyang.jpg')} style={{width:170*s,height:130*s}} />
                ...
                <View style={styles.box}>
                    <View style={styles.xinzhi}>
                        <ImageBackground source={require('../../../assets/gonglve/xinzhi.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:65*s,marginTop:10*s}}>新知社</Text>
                    </View>
                    <View style={styles.faxue}>
                        <ImageBackground source={require('../../../assets/gonglve/faxueshe.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:65*s,marginTop:10*s}}>法学社</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.kaoyan}>
                        <ImageBackground source={require('../../../assets/gonglve/kaoyanjiuye.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>考研与就业协会</Text>
                    </View>
                    <View style={styles.shizheng}>
                        <ImageBackground source={require('../../../assets/gonglve/shizheng.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>时政论坛设</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.bian}>
                        <ImageBackground source={require('../../../assets/gonglve/bian.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>彼岸演讲社</Text>
                    </View>
                    <View style={styles.yingyuaihaozhe}>
                        <ImageBackground source={require('../../../assets/gonglve/yyaihaozhe.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>英语爱好者协会</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.kuangye}>
                        <ImageBackground source={require('../../../assets/gonglve/kuangyeyy.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>狂野英语社</Text>
                    </View>
                    <View style={styles.yuedu}>
                        <ImageBackground source={require('../../../assets/gonglve/yueduzhe.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>悦读者交流协会</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.zhixing}>
                        <ImageBackground source={require('../../../assets/gonglve/zhixingshe.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:65*s,marginTop:10*s}}>知行社</Text>
                    </View>
                    <View style={styles.lixiang}>
                        <ImageBackground source={require('../../../assets/gonglve/lxdd.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>理想担当青年社</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.daxuesheng}>
                        <ImageBackground source={require('../../../assets/gonglve/sibian.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:42*s,marginTop:10*s}}>大学生思辨社</Text>
                    </View>
                    <View style={styles.yingyu}>
                        <ImageBackground source={require('../../../assets/gonglve/yyjlb.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:40*s,marginTop:10*s}}>DEC英语俱乐部</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.hebei}>
                        <ImageBackground source={require('../../../assets/gonglve/jingmaoyy.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:22*s,marginTop:10*s}}>河北师大经贸英语社</Text>
                    </View>
                    <View style={styles.daxue}>
                        <ImageBackground source={require('../../../assets/gonglve/chuangye.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>大学生创业协会</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.shengwu}>
                        <ImageBackground source={require('../../../assets/gonglve/swahz.jpg')} style={{width:170*s,height:130*s}} />
                ...
                <View style={styles.box}>
                    <View style={styles.shuma}>
                        <ImageBackground source={require('../../../assets/gonglve/shuma.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>数码PC协会</Text>
                    </View>
                    <View style={styles.diannao}>
                        <ImageBackground source={require('../../../assets/gonglve/diannao.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>电脑爱好者协会</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.eyu}>
                        <ImageBackground source={require('../../../assets/gonglve/eyu.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>俄语桦林社</Text>
                    </View>
                    <View style={styles.xiyu}>
                        <ImageBackground source={require('../../../assets/gonglve/xiyu.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:65*s,marginTop:10*s}}>西语社</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.yitong}>
                        <ImageBackground source={require('../../../assets/gonglve/yitong.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>译通英语社</Text>
                    </View>
                    <View style={styles.yinghua}>
                        <ImageBackground source={require('../../../assets/gonglve/yinghua.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:65*s,marginTop:10*s}}>樱花社</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.hongxue}>
                        <ImageBackground source={require('../../../assets/gonglve/hongxue.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:65*s,marginTop:10*s}}>红学会</Text>
                    </View>
                    <View style={styles.jinglun}>
                        <ImageBackground source={require('../../../assets/gonglve/jinglun.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>经伦汉语言协会</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.qianyuan}>
                        <ImageBackground source={require('../../../assets/gonglve/qianyuan.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>乾元国学社</Text>
                    </View>
                    <View style={styles.zifeng}>
                        <ImageBackground source={require('../../../assets/gonglve/zifeng.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>子风文学社</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.chunqiu}>
                        <ImageBackground source={require('../../../assets/gonglve/chunqiu.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:55*s,marginTop:10*s}}>春秋诗社</Text>
                    </View>
                    <View style={styles.hanyu}>
                        <ImageBackground source={require('../../../assets/gonglve/hanyu.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>韩国语协会</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.wuxian}>
                        <ImageBackground source={require('../../../assets/gonglve/wuxiandian.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:50*s,marginTop:10*s}}>无线电协会</Text>
                    </View>
                    <View style={styles.tianwen}>
                        <ImageBackground source={require('../../../assets/gonglve/tianwen.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>天文爱好者协会</Text>
                    </View>
                </View>
                <View style={styles.box}>
                    <View style={styles.qianru}>
                        <ImageBackground source={require('../../../assets/gonglve/qianrushi.jpg')} style={{width:170*s,height:130*s}} />
                        <Text style={{marginLeft:37*s,marginTop:10*s}}>嵌入式电子协会</Text>
                    </View>
                    <View style={styles.web}>
                        <ImageBackground source={require('../../../assets/gonglve/web.jpg')} style={{width:170*s,height:130*s}} />
