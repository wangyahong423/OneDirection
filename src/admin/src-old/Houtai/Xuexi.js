        ...
        return (
            ...
            <div>
                ...
                <div className="homediv1">
                    ...
                    <p style={{fontSize:16,float:"left",marginLeft:"8%",marginTop:"1.5%"}}>学习交流</p>
                </div>
                <div className="homediv2">
                    ...
                    <Link to="/xuexi">
                        <p className="iconfont icon-fangzi" style={{fontSize:18,marginTop:"8%",color:"#456ab5"}}>学习交流</p>
                        <p style={{marginTop:"-28%",fontSize:25,color:"#555151"}}>___________</p>
                    </Link>
                    <Link to="/wenjian">
                ...
                <div className="homediv3">
                    ...
                    <div style={{height:600,width:"100%",float:"left"}}>
                        <div className="homedivlisttop">
                            <p style={{float:"left",marginLeft:"6%",marginTop:"4%"}}>标题</p>
                            <p style={{float:"left",marginLeft:"20%",marginTop:"4%"}}>内容</p>
                            <p style={{float:"left",marginLeft:"20%",marginTop:"4%"}}>姓名</p>
                            <p style={{float:"left",marginLeft:"12%",marginTop:"4%"}}>时间</p>
                            <p style={{float:"left",marginLeft:"12%",marginTop:"4%"}}>操作</p>
                        </div>
                        <div className="homedivlist">
                            <p style={{float:"left",marginLeft:"3%",marginTop:"2%"}}>高能物理那些事</p>
                            <p style={{float:"left",marginLeft:"7%",marginTop:"2%"}}>说到高能物理，很多人都会想到……</p>
                            <p style={{float:"left",marginLeft:"8%",marginTop:"2%"}}>薛干事</p>
                            <p style={{float:"left",marginLeft:"10%",marginTop:"2%"}}>9102/12/4</p>
                            <p style={{float:"left",marginLeft:"9.5%",marginTop:"2%",color:"#456ab5"}}>操作</p>
                        </div>
                        <div className="homedivlist">
                            <p style={{float:"left",marginLeft:"3%",marginTop:"2%"}}>高能物理那些事</p>
                            <p style={{float:"left",marginLeft:"7%",marginTop:"2%"}}>说到高能物理，很多人都会想到……</p>
                    ...
                    <p style={{float:"left",marginTop:"-3.7%",marginLeft:"34%",fontSize:12}}>共46条</p>
