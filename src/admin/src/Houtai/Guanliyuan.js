        ...
        return (
            ...
            <div>
                ...
                <div className="homediv1">
                    ...
                    <p style={{fontSize:16,float:"left",marginLeft:"8%",marginTop:"1.5%"}}>管理员</p>
                </div>
                <div className="homediv2">
                    ...
                    <Link to="/Guanliyuan">
                        <p className="iconfont icon-fangzi" style={{fontSize:18,marginTop:"8%",color:"#456ab5"}}>管理员</p>
                        <p style={{marginTop:"-28%",fontSize:25,color:"#555151"}}>___________</p>
                    </Link>
                    </ul>
                </div>
                <div className="homediv3">
                    ...
                    <button style={{marginTop:"1.8%",marginLeft:"7%",borderRadius:"4px",fontSize:12,width:"4.2%",height:"5%",backgroundColor:"blue",color:"white",borderColor:"blue"}}>倒序</button>
                    <button style={{marginTop:"1.8%",marginLeft:"5%",borderRadius:"4px",fontSize:12,width:"4.2%",height:"5%",backgroundColor:"white"}}>全部</button>
                    <button style={{marginTop:"1.8%",marginLeft:"5%",borderRadius:"4px",fontSize:12,width:"6%",height:"5%",backgroundColor:"white"}}>添加管理员</button>
                    <div style={{height:600,width:"100%",float:"left"}}>
                        <div className="homedivlisttop">
                            <p style={{float:"left",marginLeft:"10%",marginTop:"4%"}}>名字</p>
                            <p style={{float:"left",marginLeft:"20%",marginTop:"4%"}}>性别</p>
                            <p style={{float:"left",marginLeft:"20%",marginTop:"4%"}}>电话</p>                            
                            <p style={{float:"left",marginLeft:"20%",marginTop:"4%"}}>密码</p>
                        </div>
                        <div className="homedivlist">
                            <p style={{float:"left",marginLeft:"10%",marginTop:"2%"}}>Admin1</p>
                            <p style={{float:"left",marginLeft:"20%",marginTop:"2%"}}>男</p>
                            <p style={{float:"left",marginLeft:"18%",marginTop:"2%"}}>13788888888</p>
                            <p style={{float:"left",marginLeft:"16%",marginTop:"2%"}}>888886</p>
                        </div>
                        <div className="homedivlist">
                            <p style={{float:"left",marginLeft:"10%",marginTop:"2%"}}>Admin1</p>
                            <p style={{float:"left",marginLeft:"20%",marginTop:"2%"}}>男</p>
                    ...
                    <button style={{float:"left",marginTop:"-4%",marginLeft:"44%",width:"1.8%",height:"4%",borderRadius:3,borderColor:"white",backgroundColor:"white",fontSize:11,color:"gary"}}>1</button>
                    <button style={{float:"left",marginTop:"-4%",marginLeft:"46%",width:"1.8%",height:"4%",borderRadius:3,borderColor:"white",backgroundColor:"white",fontSize:11,color:"gary"}}>2</button>
                </div>
            </div>
            </>
        )
